#ifndef OPENMM_WINDOWSEXPORTIC_H_
#define OPENMM_WINDOWSEXPORTIC_H_
 ...
 *     IC_BUILDING_{SHARED|STATIC}_LIBRARY
...
#if defined(IC_BUILDING_SHARED_LIBRARY)
#define OPENMM_EXPORT_IC __declspec(dllexport)
#elif defined(IC_BUILDING_STATIC_LIBRARY) || defined(IC_USE_STATIC_LIBRARIES)
#define OPENMM_EXPORT_IC
#else
#define OPENMM_EXPORT_IC \
    __declspec(dllimport)  // i.e., a client of a shared library
#endif
#else
#define OPENMM_EXPORT_IC  // Linux, Mac
#endif

#endif  // OPENMM_WINDOWSEXPORTIC_H_